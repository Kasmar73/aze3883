...
// Log faylı
$log_file = 'logs/simple_webhook_' . date('Y-m-d') . '.log';
...
writeLog("Simple webhook çağırıldı - Method: " . $_SERVER['REQUEST_METHOD']);
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    echo json_encode([
        'status' => 'success',
        'message' => 'Simple webhook işləyir',
        'method' => 'GET',
        'timestamp' => date('Y-m-d H:i:s')
    ]);
    exit;
...
writeLog("Simple webhook tamamlandı");
?>