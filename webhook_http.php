<?php
// HTTP webhook faylı (SSL olmadan)
header('Content-Type: application/json');

// Log faylı
$log_file = 'logs/webhook_http_' . date('Y-m-d') . '.log';
...
writeLog("HTTP Webhook çağırıldı - Method: " . $_SERVER['REQUEST_METHOD']);
...
writeLog("HTTP Webhook tamamlandı");
?>